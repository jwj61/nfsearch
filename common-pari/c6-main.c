                                ...
                                */
                                ...
                                for(count[5] =low[5]; count[5]<= high[5];
                                  ...
                                  if(!gcmp0(td)) {
                                    ...
                                    /* This is where we could look for complete squares */
